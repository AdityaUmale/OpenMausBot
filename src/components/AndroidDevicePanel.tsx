    ...
    <div className="space-y-3 pb-5">
      ...
      <div className="rounded-xl bg-card p-4">
        ...
        <ol className="mt-2 list-decimal space-y-1.5 pl-4 text-[11.5px] leading-relaxed text-ink-secondary">
          ...
          <li>
            {t("computer.android.step2a")} <span className="text-ink">{t("computer.android.buildNumber")}</span>{" "}
            {t("computer.android.step2b")} <span className="text-ink">{t("computer.android.usbDebugging")}</span>.
          </li>
          <li>
