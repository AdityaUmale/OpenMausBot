...
const MessagesList = memo(function MessagesList({
  ...
  bot: Bot;
  messages: Message[];
  /** The active locale. Not read here: it is the memo key. Every bubble in
   * this subtree renders catalog strings, and none of the other props change
   * when the language does, so without it the settled transcript keeps the
